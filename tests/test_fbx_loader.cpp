...
TEST_CASE("FBX invalid geometry and texture paths preserve the Expected error contract")
{
    ...
    for (const auto& invalid :
         {InvalidInput {"Normals: *9 { a: 0,0,1,0,0,1,0,0,1 }",
          ...
          InvalidInput {"Vertices: *9 { a: 0,0,0,100,0,0,0,100,0 }",
                        "Vertices: *9 { a: -3e38,0,0,3e38,0,0,0,1,0 }",
                        "invalid tangent",
                        false,
                        false},
          InvalidInput {"Vertices: *9 { a: 0,0,0,100,0,0,0,100,0 }",
                        "Vertices: *9 { a: 0,0,0,1e20,0,0,0,1,0 }",
                        "invalid tangent",
                        false,
                        false},
          InvalidInput {"UV: *6 { a: 0,0,1,0,0,1 }", "UV: *6 { a: -3e38,0,3e38,0,0,1 }", "invalid tangent"},
